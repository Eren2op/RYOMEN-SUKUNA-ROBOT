        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "ÔwÔ! My Owner And The Leader Of Akatsuki Organization Is Here!",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Akatsuki Organization just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Huh! An Asura Path just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Wow! Someone with A Human Path level just joined!",
                    reply_to_message_id=reply,
                )
                continue
                ...
                if welc_mutes == "strong":
                    ...
                    message = msg.reply_text(
                        ...
                        reply_markup=InlineKeyboardMarkup([{
                            InlineKeyboardButton(
                                text="Hai, Watashi Wa Ningendesu!",
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "The Almighty Pain Is Leaving,But He Will Be BACK!", reply_to_message_id=reply)
                return
